...
export interface CdnInterface {
    ...
    guildDiscoverySplash: (guildId: string, guildDiscoverySplash: string) => string;
    ...
    guildMemberAvatar: (guildId: string, userId: string, memberAvatar: string) => string;
    ...
    achievementIcon: (applicationId: string, achievementId: string, iconHash: string) => string;
    ...
    guildScheduledEventCover: (scheduledEventId: string, scheduledEventCoverImage: string) => string;
}
//# sourceMappingURL=ConstantInterface.d.ts.map